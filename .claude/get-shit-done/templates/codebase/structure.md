...
- Usage: Reference from command with `@/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
