...
<!-- For checkpoint task examples and patterns, see @/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
