...
- **Global scope**: `/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/notes/`)
...
2. Glob `/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/notes/` — works in any directory
