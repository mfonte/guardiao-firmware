...
5. Commit:
   ```bash
   node "/Users/manoel/repo/guardiao-project/guardiao-firmware/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
